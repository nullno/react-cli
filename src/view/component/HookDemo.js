import React,{useState,useRef,useEffect,useContext,useMemo,useReducer} from 'react'
...
const ButtonItems=(props)=>{
	           ...
	           const [comdata,dispatchComdata] =useReducer((state,action)=>{
	               ...
	               <div style={BoxStyle}>   
	                 ...
	                 <h2>comdata:</h2>
	                  <div style={{display:'flex',justifyContent:'space-between',margin:'10px 0'}}>
		                 ...
		                 <button style={_default} onClick={()=>dispatchComdata({type:'setname',name:'nullno.com'})}>{comdata.name}</button>
		                 ---
		                 <button style={_default} onClick={()=>dispatchComdata({type:'setyear',year:'2021'})}>{comdata.year}</button> 
